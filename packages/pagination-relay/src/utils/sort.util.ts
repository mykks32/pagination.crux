/**
 * Sort-field helpers shared by the paginator: normalizing caller-supplied
 * sort definitions, converting them to Mongoose's `.sort()` shape, and
 * inverting them for backward (`before`/`last`) pagination.
 */
